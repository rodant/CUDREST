...
@Dependent public class ServerMarshallingFactoryImpl implements MarshallerFactory {
  ...
  @Inject @ObserverModel private Event<HelloMessage> var3;
  @Inject @ObserverModel private Event<Response> var4;
  ...
  private Marshaller<HelloMessage> de_itasesor_client_shared_HelloMessage;
  ...
  private Marshaller<Response> de_itasesor_client_shared_Response;
  ...
  public ServerMarshallingFactoryImpl() {
    ...
    de_itasesor_client_shared_HelloMessage = new Marshaller<HelloMessage>() {
      ...
      public HelloMessage demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: de.itasesor.client.shared.HelloMessage", t);
        }
      }
      public String marshall(HelloMessage a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"de.itasesor.client.shared.HelloMessage\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"de.itasesor.client.shared.HelloMessage\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("de.itasesor.client.shared.HelloMessage", de_itasesor_client_shared_HelloMessage);
    ...
    de_itasesor_client_shared_Response = new Marshaller<Response>() {
      ...
      public Response demarshall(EJValue a0, MarshallingSession a1) {
        try {
          ...
          t.printStackTrace();
          throw new RuntimeException("error demarshalling entity: de.itasesor.client.shared.Response", t);
        }
      }
      public String marshall(Response a0, MarshallingSession a1) {
        ...
        if (a1.hasObject(a0)) {
          String objId = a1.getObject(a0);
          return new StringBuilder(128).append("{\"^EncodedType\":\"de.itasesor.client.shared.Response\"").append(",").append("\"^ObjectID\":\"").append(objId).append("\"}").toString();
        }
        String objId = a1.getObject(a0);
        a1.recordObject(objId, objId);
        return new StringBuilder(384).append("{\"^EncodedType\":\"de.itasesor.client.shared.Response\",\"^ObjectID\":\"").append(objId).append("\"").append(",").append("\"id\" : ").append(java_lang_Integer.marshall(a0.getId(), a1)).append(",").append("\"message\" : ").append(java_lang_String.marshall(a0.getMessage(), a1)).append("}").toString();
      }
    };
    marshallers.put("de.itasesor.client.shared.Response", de_itasesor_client_shared_Response);
